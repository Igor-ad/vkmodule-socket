...
class Socket2CommandTest extends BaseCommandTestCase
{
    public static function commandDataProvider(): array
    {
        return [
            ...
            'SetInput1' => [
                'command' => 'input_setup',
                'queryString' => '{"command":{"data":{"input":{"inputNumber":1,"action":1,"antiBounce":5}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-2"}}',
            ...
            'GetInput' => [
                ...
                'queryString' => '{"command":{"data":{"input":{"inputNumber":1}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-2"}}',
            ...
            'RelayAction0' => [
                ...
                'queryString' => '{"command":{"data":{"relay":{"relayNumber":0,"action":1,"interval":5}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-2"}}',
            ...
            'RelayAction1' => [
                'command' => 'relay_control',
                'queryString' => '{"command":{"data":{"relay":{"relayNumber":1,"action":1,"interval":5}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-2"}}',
            ...
            'RelayActionOn' => [
                'command' => 'relay_on',
                'queryString' => '{"command":{"data":{"relay":{"relayNumber":1}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-2"}}',
