...
class Socket5CommandTest extends BaseCommandTestCase
{
    public static function commandDataProvider(): array
    {
        return [
            'SetInput0' => [
                'command' => 'input_setup',
                'queryString' => '{"command":{"data":{"input":{"inputNumber":0,"action":1,"antiBounce":5}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-5"}}',
            ...
            'SetInput1' => [
                'command' => 'input_setup',
                'queryString' => '{"command":{"data":{"input":{"inputNumber":1,"action":1,"antiBounce":5}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-5"}}',
            ...
            'SetInput2' => [
                'command' => 'input_setup',
                'queryString' => '{"command":{"data":{"input":{"inputNumber":2,"action":1,"antiBounce":5}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-5"}}',
            ...
            'SetInput3' => [
                'command' => 'input_setup',
                'queryString' => '{"command":{"data":{"input":{"inputNumber":3,"action":1,"antiBounce":5}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-5"}}',
            ...
            'GetInput' => [
                ...
                'queryString' => '{"command":{"data":{"input":{"inputNumber":1}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-5"}}',
            ...
            'RelayAction0' => [
                ...
                'queryString' => '{"command":{"data":{"relay":{"relayNumber":0,"action":1,"interval":5}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-5"}}',
            ...
            'RelayAction1' => [
                'command' => 'relay_control',
                'queryString' => '{"command":{"data":{"relay":{"relayNumber":1,"action":1,"interval":5}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-5"}}',
            ...
            'RelayAction2' => [
                'command' => 'relay_control',
                'queryString' => '{"command":{"data":{"relay":{"relayNumber":2,"action":1,"interval":5}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-5"}}',
            ...
            'RelayAction3' => [
                'command' => 'relay_control',
                'queryString' => '{"command":{"data":{"relay":{"relayNumber":3,"action":1,"interval":5}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-5"}}',
            ...
            'RelayActionOn' => [
                'command' => 'relay_on',
                'queryString' => '{"command":{"data":{"relay":{"relayNumber":1}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-5"}}',
            ...
            'GetAllStatus' => [
                'command' => 'status',
                'queryString' => '{"module":{"host":"127.0.0.1","port":9761,"type":"Socket-5"}}',
