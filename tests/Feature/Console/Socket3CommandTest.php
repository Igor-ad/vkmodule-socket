    ...
    public static function commandDataProvider(): array
    {
        return [
            ...
            'Socket3RelayAction0' => [
                ...
                'queryString' => '{"command":{"data":{"relay":{"relayNumber":0,"action":1,"interval":5}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-3"}}',
            ...
            'Socket3RelayAction1' => [
                'command' => 'relay_control',
                'queryString' => '{"command":{"data":{"relay":{"relayNumber":1,"action":1,"interval":5}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-3"}}',
