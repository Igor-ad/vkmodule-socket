    ...
    public static function commandDataProvider(): array
    {
        return [
            'RelayAction0' => [
                ...
                'queryString' => '{"command":{"data":{"relay":{"relayNumber":0,"action":1,"interval":5}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-4"}}',
            ...
            'RelayAction1' => [
                'command' => 'relay_control',
                'queryString' => '{"command":{"data":{"relay":{"relayNumber":1,"action":1,"interval":5}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-4"}}',
            ...
            'RelayAction2' => [
                'command' => 'relay_control',
                'queryString' => '{"command":{"data":{"relay":{"relayNumber":2,"action":1,"interval":5}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-4"}}',
            ...
            'RelayAction3' => [
                'command' => 'relay_control',
                'queryString' => '{"command":{"data":{"relay":{"relayNumber":3,"action":1,"interval":5}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-4"}}',
            ...
            'RelayAction4' => [
                'command' => 'relay_control',
                'queryString' => '{"command":{"data":{"relay":{"relayNumber":4,"action":1,"interval":5}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-4"}}',
            ...
            'RelayAction5' => [
                'command' => 'relay_control',
                'queryString' => '{"command":{"data":{"relay":{"relayNumber":5,"action":1,"interval":5}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-4"}}',
            ...
            'RelayAction6' => [
                'command' => 'relay_control',
                'queryString' => '{"command":{"data":{"relay":{"relayNumber":6,"action":1,"interval":5}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-4"}}',
            ...
            'RelayAction7' => [
                'command' => 'relay_control',
                'queryString' => '{"command":{"data":{"relay":{"relayNumber":7,"action":1,"interval":5}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-4"}}',
            ...
            'RelayActionOn' => [
                'command' => 'relay_on',
                'queryString' => '{"command":{"data":{"relay":{"relayNumber":1}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-4"}}',
            ...
            'GetAllStatus' => [
                'command' => 'status',
                'queryString' => '{"module":{"host":"127.0.0.1","port":9761,"type":"Socket-4"}}',
