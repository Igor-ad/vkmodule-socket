...
class Socket1CommandTest extends AbstractCommand
{
    public static function commandDataProvider(): array
    {
        return [
            'Socket1SetInput0' => [
                ...
                'expectedString' => '{"success":true,"event":{"id":"30","description":"Socket1SetInput","data":{"input":{"inputNumber":0,"triggerAction":"Open","antiBounce":5}}}}',
            ],
            'Socket1SetInput1' => [
                'command' => 'input_setup',
                ...
                'expectedString' => '{"success":true,"event":{"id":"30","description":"Socket1SetInput","data":{"input":{"inputNumber":1,"triggerAction":"Open","antiBounce":5}}}}',
            ],
            'Socket1SetInput2' => [
                'command' => 'input_setup',
                ...
                'expectedString' => '{"success":true,"event":{"id":"30","description":"Socket1SetInput","data":{"input":{"inputNumber":2,"triggerAction":"Open","antiBounce":5}}}}',
            ],
            'Socket1SetInput3' => [
                'command' => 'input_setup',
                ...
                'expectedString' => '{"success":true,"event":{"id":"30","description":"Socket1SetInput","data":{"input":{"inputNumber":3,"triggerAction":"Open","antiBounce":5}}}}',
            ],
            'Socket1GetInput' => [
