...
class Socket1CommandTest extends BaseCommandTestCase
{
    public static function commandDataProvider(): array
    {
        return [
            ...
            'Socket1SetInput1' => [
                'command' => 'input_setup',
                'queryString' => '{"command":{"data":{"input":{"inputNumber":1,"action":1,"antiBounce":5}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-1"}}',
            ...
            'Socket1SetInput2' => [
                'command' => 'input_setup',
                'queryString' => '{"command":{"data":{"input":{"inputNumber":2,"action":1,"antiBounce":5}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-1"}}',
            ...
            'Socket1SetInput3' => [
                'command' => 'input_setup',
                'queryString' => '{"command":{"data":{"input":{"inputNumber":3,"action":1,"antiBounce":5}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-1"}}',
            ...
            'Socket1GetInput' => [
                ...
                'queryString' => '{"command":{"data":{"input":{"inputNumber":1}}},"module":{"host":"127.0.0.1","port":9761,"type":"Socket-1"}}',
