...
#[CoversClass(FallbackModuleController::class)]
class FallbackModuleControllerTest extends ControllerPrepare
{
    public function testCheckConnection(): void
    {
        ...
        $this->controller = new FallbackModuleController($this->service);
